...
//            SpaceListDTO spaceListDTO = restTemplate.getForObject(uri, SpaceListDTO.class);
...
//
//                MetrospaceEntity metrospaceEntity = new MetrospaceEntity(spaceDTO.getSpceId(), spaceDTO.getCnterId(), spaceDTO.getSpceNm(),spaceDTO.getSpceTyNm(), spaceDTO.getSeatTyNm(),spaceDTO.getSeatSeNm(),spaceDTO.getDvrAr(),spaceDTO.getCmnuseAr(), spaceDTO.getRentAmt(),spaceDTO.getGrntyAmt(),spaceDTO.getSeatCompany(), 0);
...
//        }
        ...
        for (ProvincialCenterEntity provincialCenterEntity : provincialCenterEntityList) {
            ...
            for (SpaceDTO spaceDTO : spaceListDTO.getAreaCenterList()) {
                ...
                ProvspaceEntity provspaceEntity = new ProvspaceEntity(spaceDTO.getSpceId(), spaceDTO.getCnterId(), spaceDTO.getSpceNm(), spaceDTO.getSpceTyNm(), spaceDTO.getSeatTyNm(), spaceDTO.getSeatSeNm(), spaceDTO.getDvrAr(), spaceDTO.getCmnuseAr(), spaceDTO.getRentAmt(), spaceDTO.getGrntyAmt(), spaceDTO.getSeatCompany(), 0);
